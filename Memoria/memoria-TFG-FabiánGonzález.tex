...
\usepackage[
  ...
  plainpages=false,
  pagebackref=true
]{hyperref} %hiperenlaces y backcites

\let\origacs\acs
\renewcommand{\acs}[1]{\textbf{\origacs{#1}}}
...
\hspace{3mm}
Quiero agradecer a mi tutor, D. Francisco de Sande, por su guía, disponibilidad y orientación a lo largo de todo el desarrollo de este trabajo. Sus consejos y el rigor con el que ha dirigido el proyecto han sido fundamentales para llevar esta investigación a buen puerto.
\vspace*{0.3cm}
...
\include{capitulos/Cap6_Arquitectura_y_Diseño}
\include{capitulos/Cap7_Desarrollo}
\include{capitulos/Cap8_Resultados}
\include{capitulos/Cap9_Conclusiones_y_Lineas_de_Trabajo_Futuras}
\include{capitulos/Cap9_Conclusions_and_Future_Lines_of_Work}
\include{capitulos/Cap_Acronimos}
\include{capitulos/Cap10_Budget}
