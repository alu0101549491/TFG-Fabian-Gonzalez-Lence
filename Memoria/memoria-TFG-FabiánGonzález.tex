...
\newcommand{\HRule}{\rule{\linewidth}{0.3mm}}
{
    ...
    \vspace*{\stretch{1}}
    \begin{center}
        \fontsize{18pt}{18pt}\selectfont La Laguna, {\selectlanguage{spanish}\today}
    \end{center}
}
