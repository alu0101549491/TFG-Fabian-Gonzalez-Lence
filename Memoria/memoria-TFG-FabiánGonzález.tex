...
\begin{palabrasClave}
Inteligencia Artificial, IA Generativa, Modelos de Lenguaje de Gran Tamaño, Generación de Código, Ingeniería del Software, Desarrollo Asistido por IA, Calidad del Software, Colaboración Multiagente, Prompt Engineering.
\end{palabrasClave}
\end{abstract}
...
\begin{keywords}
Artificial Intelligence, Generative AI, Large Language Models, Code Generation, Software Engineering, AI-Assisted Development, Software Quality, Multi-Agent Collaboration, Prompt Engineering.
\end{keywords}
\end{abstract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
