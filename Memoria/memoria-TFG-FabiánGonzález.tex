...
\newcommand{\TitleTopic}{%
  \texttt{Análisis de Capacidades de la IA en la Generación Semiautomática de Aplicaciones Complejas}%
}
...
\hypersetup{
    pdftitle={Title},
    pdfauthor={Fabián González Lence},
    pdfkeywords={LLMs},
    pdfsubject={Final Degree Project on XXX}
}
...
\newcommand{\HRule}{\rule{\linewidth}{0.3mm}}
{
    ...
    \HRule\vspace*{-2mm}
    \begin{flushright}
        {\fontsize{32pt}{32pt}\selectfont Análisis de Capacidades de la IA en la Generación Semiautomática de Aplicaciones Complejas\par
        \vspace*{3mm}
        \fontsize{18pt}{18pt}\selectfont \textit{Estudio del código generado por modelos de Inteligencia Artificial}\par
        \vspace*{11mm}
        \fontsize{16pt}{16pt}\selectfont Fabián González Lence
        }\vspace*{12mm}
    \end{flushright}
    \HRule
...
\bigskip
%Cambiar
\noindent ha sido realizado bajo su dirección por D. {\bf Fabián González Lence}.
...
Quiero agradecer a mi tutor, D. Francisco de Sande González, por su guía, disponibilidad y orientación a lo largo de todo el desarrollo de este trabajo. Sus consejos y el rigor con el que ha dirigido el proyecto han sido fundamentales para llevar esta investigación a buen puerto.
...
\begin{abstract}
{\em
El rápido avance de los modelos de lenguaje de gran tamaño (LLMs) ha abierto nuevas posibilidades en el ámbito del desarrollo de software asistido por inteligencia artificial. Este Trabajo de Fin de Grado analiza las capacidades de distintos modelos de IA generativa ---Claude, ChatGPT, GitHub Copilot, Mistral, entre otros--- para dar soporte a las diferentes fases del ciclo de vida del software de forma colaborativa y semiautomática.\\

Con el objetivo de evaluar de manera sistemática el rendimiento de estos modelos, se ha diseñado y seguido una metodología experimental basada en las fases clásicas de la ingeniería del software: especificación de requisitos, diseño, implementación, revisión, pruebas y despliegue. Dicha metodología se ha aplicado al desarrollo de cinco aplicaciones de complejidad creciente: un juego del ahorcado, un reproductor web de música, una versión simplificada del videojuego Balatro, un gestor de proyectos cartográficos y un gestor de torneos de tenis.\\

Para cada aplicación, se han generado múltiples versiones de los artefactos de desarrollo ---requisitos en lenguaje natural, semiformales y en lenguaje controlado, diagramas UML y código fuente--- utilizando distintos modelos de IA como agentes especializados. El proceso ha sido documentado rigurosamente, registrando los prompts empleados, las respuestas obtenidas y las decisiones tomadas en cada etapa.\\
...
\begin{palabrasClave}
Inteligencia Artificial, Modelos de Lenguaje de Gran Tamaño, LLM, Generación de Código, Ingeniería del Software, Desarrollo Asistido por IA, Ciclo de Vida del Software, Evaluación de Modelos, Colaboración Multiagente, Prompt Engineering.
\end{palabrasClave}
\end{abstract}
...
% ha puesto.
\markboth{Fabián González Lence}{ULL}
...
%\include{capitulos/Cap_Instrucciones}
\include{capitulos/Cap0_Preface}
\include{capitulos/Cap1_Metas}
\include{capitulos/Cap2_Introduccion}
\include{capitulos/Cap3_Estado_del_Arte}
\include{capitulos/Cap4_Modelos_de_IA}
\include{capitulos/Cap5_Metodologia}
\include{capitulos/Cap6_Diseño}
\include{capitulos/Cap7_Codificacion}
\include{capitulos/Cap8_Pruebas}
\include{capitulos/Cap9_Resultados}
\include{capitulos/Cap10_Conclusiones_y_Lineas_de_Trabajo_Futuras}
\include{capitulos/Cap10_Conclusions_and_Future_Lines_of_Work}
\include{capitulos/Cap_Acronimos}
\include{capitulos/Cap11_Budget}
\include{capitulos/Cap12_Dummy}
