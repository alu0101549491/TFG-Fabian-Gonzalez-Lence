...
\begin{comment}
% Spacing around floats (tables, figures)
\setlength{\intextsep}{8pt}      % space above and below [h]/[H] floats
\setlength{\textfloatsep}{10pt}  % space between float and text at top/bottom of page
\setlength{\floatsep}{8pt}       % space between consecutive floats
\end{comment}
...
\begin{abstract}
{\em
El rápido avance de los grandes modelos de lenguaje (LLMs) ha abierto nuevas posibilidades en el ámbito del desarrollo de software asistido por inteligencia artificial. Este Trabajo de Fin de Grado analiza las capacidades de distintos modelos de IA generativa para dar soporte a las diferentes fases del ciclo de vida del software de forma colaborativa y semiautomática.\\
...
\include{capitulos/Cap2_Estado_del_Arte}
\include{capitulos/Cap3_Modelos_de_IA}
\include{capitulos/Cap4_Metodologia}
\include{capitulos/Cap5_Arquitectura_y_Diseño}
\include{capitulos/Cap6_Desarrollo}
\include{capitulos/Cap7_Resultados}
\include{capitulos/Cap8_Conclusiones_y_Lineas_de_Trabajo_Futuras}
