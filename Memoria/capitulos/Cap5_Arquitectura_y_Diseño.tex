...
La Figura~\ref{fig:hangman-class-diagram} muestra el diagrama definitivo de \ac{HANGMAN}. 
Dada la complejidad de los diagramas UML no es viable exponerlos en este documento, pero se encuentran todos en el repositorio del proyecto y referenciados en esta memoria.
