...
\begin{enumerate}
\item Miembros del Tribunal
• Patricio García
• Gara Miranda
• Francisco Almeida
\item Tareas Pendientes: Test Anti-Plagio

\item Buscar en todo el documento (grep) las palabras ?rompt*, ?ester, ?esting, assets y garantizar que se escriben SIEMPRE en cursiva.

\item Buscar en todo el documento (grep) para asegurar que Arquitecto, Revisora, etc.. (los roles de la IA) mantienen coherencia en cuanto al género de la palabra usada en todo el documento.

\item Revisar que todas las referencias bibliográficas sean tales y no URLs, porque en ese caso debieran ser notas a pie de página, salvo 2 casos concretos.

\item Revisar que sea correcto el renderizado en el pdf de todos los títulos de la bibliografía.

\item Revisar a partir de la lista de acrónimos que para todos se introduce su significado la primera vez que se utilizan.
