...
Modelos de propósito general como GPT-5 (OpenAI)\footnote{GPT-5: \href{https://cdn.openai.com/gpt-5-system-card.pdf}{gpt-5-system-card.pdf}}, Claude Sonnet 4.5 (Anthropic)\footnote{Claude Sonnet 4.5: \href{https://www.anthropic.com/claude-sonnet-4-5-system-card}{claude-sonnet-4-5-system-card.pdf}}, Gemini 3 Pro (Google)\footnote{Gemini 3: \href{https://storage.googleapis.com/deepmind-media/Model-Cards/Gemini-3-Pro-Model-Card.pdf}{Gemini-3-Pro-Model-Card.pdf}} o Mistral Large (Mistral AI)\footnote{Mistral Large: \href{https://docs.mistral.ai/models/model-cards/mistral-large-2-0-24-07}{mistral-large-model-card}} compiten en tareas de razonamiento sobre código, diseño arquitectónico y generación de documentación técnica.
...
``Prácticas Externas'', en el que estudiamos la personalización de agentes \cite{URL::TFG}.\\
