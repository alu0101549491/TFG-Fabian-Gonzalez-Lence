...
El prompt de arquitectura desarrollado para esta fase y detallado en el Capítulo~\ref{chap:Metodology} incluye instrucciones precisas sobre la pila tecnológica, los patrones de diseño a aplicar y el formato esperado de los artefactos de salida.
...
\hline
\textbf{Google Gemini} &
Generación de assets gráficos (producción de recursos visuales) &
P3 &
Generación de imágenes visualmente coherentes &
Uso puntual; no integrado en el flujo formal de desarrollo \\
\hline
\textbf{Perplexity} &
