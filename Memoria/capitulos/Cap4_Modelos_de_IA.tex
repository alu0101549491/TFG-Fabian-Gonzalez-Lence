...
Qwen AI\footnote{\href{https://qwen.ai/home}{Qwen AI (\textit{chatbot})}} fue el agente de \ac{IA} \textit{Tester} durante los tres primeros proyectos, responsable de generar las suites de pruebas unitarias con Jest. Su elección respondía a su eficacia en la generación de casos de prueba siguiendo el patrón \ac{AAA}, con una tasa de compilación inicial elevada y cobertura de casos normales, límite y excepcionales.
