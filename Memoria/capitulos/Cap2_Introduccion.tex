...
El marco de evaluación de calidad adoptado es el estándar ISO/IEC 25010 (SQuaRE) \cite{ISO:25010:2023}, complementado con las categorías de reglas de SonarQube\footnote{\href{https://sonarcloud.io}{SonarQube Cloud}} ---\textit{Bugs}, \textit{Vulnerabilities}, \textit{Code Smells} y cobertura--- como referencia para la clasificación de incidencias. Los cinco proyectos cuentan con ficheros de configuración para análisis estático con SonarCloud, lo que permite obtener métricas de complejidad ciclomática \cite{McCabe:1976:Complexity}, deuda técnica y duplicación de código de forma automatizada.\\ 
...
\begin{description}
  ...
  \item[Capítulo~\ref{chap:Design}: Arquitectura y Diseño de los Proyectos.] Se presentan las especificaciones de requisitos, los diagramas de clases y casos de uso, decisiones arquitectónicas y las tecnologías seleccionadas para cada uno de los cinco proyectos, con especial atención a la progresión en complejidad.
