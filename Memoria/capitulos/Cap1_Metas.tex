...
El objetivo principal de este \ac{TFG} es evaluar de forma práctica las capacidades actuales de la \ac{IA} generativa para desarrollar aplicaciones web no triviales, analizando las prestaciones y rendimiento de varios Grandes modelos de lenguaje (\textit{Large Language Models}, LLMs) en las diferentes etapas del ciclo de vida del desarrollo de software.\\
...
\begin{enumerate}
  ...
  \item \textbf{Desarrollar cinco aplicaciones web de complejidad creciente.} Construir, mediante la colaboración entre modelos de IA y con mínima intervención humana, las siguientes aplicaciones:
  \begin{itemize}
    ...
    \item \textbf{\ac{BALATRO}}: Juego de cartas inspirado en Balatro\footnote{Balatro \url{https://es.wikipedia.org/wiki/Balatro}} con sistema de progresión por niveles, interacciones con unatienda y utiliación de manos de póker para el cálculo de puntos.
