...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item \textbf{\ac{PLAYER}}: Reproductor de música web interactivo simple desarrolado con React\footnote{React: \url{https://es.react.dev}}, TypeScript\footnote{TypeScript: \url{https://www.typescriptlang.org}} y Vite\footnote{Vite: \url{https://es.vite.dev}}. 
