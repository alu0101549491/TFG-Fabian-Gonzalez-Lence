...
\begin{enumerate}
  ...
  \item \textbf{Desarrollar cinco aplicaciones de complejidad creciente.} Construir, mediante la colaboración entre modelos de \ac{IA} las siguientes aplicaciones:
  \begin{itemize}
