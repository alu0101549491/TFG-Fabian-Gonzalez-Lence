...
Para los diagramas de casos de uso la situación fue más contundente: Claude fue el único modelo capaz de generar diagramas con sintaxis Mermaid válida y contenido fiel a los requisitos; Mistral, ChatGPT y Gemini fallaron sistemáticamente por errores de sintaxis o resultados demasiado vagos. Con Claude los resultados fueron satisfactorios desde el primer intento, la especificación \ac{LNC} condujo a los mejores diagramas para los tres primeros proyectos, mientras que para \ac{CARTO} y \ac{TENNIS} los diagramas definitivos se generaron a partir de las historias de usuario, al reflejar con mayor fidelidad los requisitos transmitidos por los clientes externos.
