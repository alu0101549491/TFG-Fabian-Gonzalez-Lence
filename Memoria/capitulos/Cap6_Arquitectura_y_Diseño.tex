...
El diagrama de clases describe las entidades del dominio, sus atributos, sus relaciones y la cardinalidad entre ellas. En \ac{HANGMAN} se reduce a nueve clases concentradas en la lógica del juego; en \ac{PLAYER} crece hasta veinticuatro, distribuidas entre componentes React, hooks y tipos; en \ac{BALATRO} crece hasta agrupar baraja, evaluador de manos, sistema de puntuación, ciegas, tienda y las tres familias de cartas especiales; en \ac{CARTO} y \ac{TENNIS} se reorganiza por capas de \textit{Clean Architecture}, distinguiendo entidades de dominio, contratos de repositorio y servicios de aplicación. En \ac{TENNIS}, este diagrama llegó a contener más de cincuenta elementos ---entidades de dominio, enumeraciones, 13 servicios de aplicación y 11 contratos de repositorio--- que el agente de arquitectura utilizó como base para generar el esqueleto completo del proyecto. La Figura~\ref{fig:hangman-class-diagram} muestra el diagrama de clases definitivo de \ac{HANGMAN}, a modo ilustrativo; los diagramas de los proyectos posteriores presentan una complejidad creciente que hace inviable reproducirlos en esta memoria.\\
