...
\textbf{Fase 2 --- Codificación.} La \ac{IA} Desarrolladora implementa cada módulo sobre los esqueletos de la Fase 1, exigiendo conformidad con la Guía de Estilo de Google para TypeScript y los principios \ac{SOLID} \cite{Martin:2003:Agile}. 
...
\section{Plantillas y estrategia de \textit{prompting}} \label{sec:prompting}
...
\hline
\textbf{Fase} & \textbf{Plantillas en el repositorio \cite{URL::TFG}} & \textbf{Patrón de \textit{prompting}} \\
\hline
...
\footnotetext[1]{\textit{Single-shot} Técnica de \textit{prompting} en la que el modelo recibe toda la información necesaria en un único \textit{prompt}.}
