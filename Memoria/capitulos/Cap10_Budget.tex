...
Los tres modelos principales se contrataron mediante planes de suscripción mensual, sin infraestructura propia ni pago por consumo de \ac{API}. Los períodos activos reflejan el rol de cada herramienta en el experimento: \textit{Claude Pro}\footnote{\href{https://claude.com/pricing/pro}{Anthropic Claude Pro --- 18,00~€/mes}} estuvo activo los siete meses completos del trabajo, siendo el modelo central del desarrollo; \textit{Le Chat Pro}\footnote{\href{https://mistral.ai/pricing}{Mistral AI Le Chat Pro --- 14,99~€/mes (IVA no incluido)}} cubrió únicamente los cuatro primeros meses, coincidiendo con el uso de Mistral en P1--P3; \textit{GitHub Copilot Pro+}\footnote{\href{https://github.com/features/copilot}{GitHub Copilot Pro+ --- 39,00~\$/mes}} se activó en marzo de 2026, al adoptar el modo agente desde \ac{CARTO}. La Tabla~\ref{tab:budget-subscriptions} detalla el coste de cada suscripción.
