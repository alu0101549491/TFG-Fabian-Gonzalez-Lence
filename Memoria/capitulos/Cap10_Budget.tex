...
\section{Suscripciones a servicios de IA} \label{sec:budget-subscriptions}

Los tres modelos principales se contrataron mediante planes de suscripción mensual, sin infraestructura propia ni pago por consumo de \ac{API}. Los períodos activos reflejan el rol de cada herramienta en el experimento: \textbf{\textit{Claude Pro}}\footnote{\href{https://claude.com/pricing/pro}{Anthropic Claude Pro --- 18,00~€/mes -- \texttt{claude.com/pricing/pro}}} estuvo activo los siete meses completos del trabajo, siendo el modelo central del desarrollo; \textbf{\textit{Le Chat Pro}}\footnote{\href{https://mistral.ai/pricing}{Mistral AI Le Chat Pro --- 14,99~€/mes (IVA no incluido) -- \texttt{mistral.ai/pricing}}} cubrió los cuatro primeros meses, coincidiendo con el uso de Mistral en P1--P3; y \textbf{\textit{GitHub Copilot Pro+}}\footnote{\href{https://github.com/features/copilot}{GitHub Copilot Pro+ --- 39,00~\$/mes -- \texttt{github.com/features/copilot}}} se activó en marzo de 2026, al adoptar el modo agente desde \ac{CARTO}. La Tabla~\ref{tab:budget-subscriptions} detalla el coste de cada suscripción.

\begin{table}[H]
\centering
\small
\renewcommand{\arraystretch}{1.3}
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{2.3cm}|>{\raggedright\arraybackslash}p{1.9cm}|>{\raggedright\arraybackslash}p{3.2cm}|>{\raggedright\arraybackslash}X|>{\raggedleft\arraybackslash}p{1.8cm}|}
\hline
...
El coste total estimado del proyecto asciende a 5.995~€, de los cuales el componente predominante es el coste laboral. El gasto en suscripciones de \ac{IA} representa un desembolso de 243~€, notablemente inferior al que implicaría el acceso a los modelos mediante \ac{API} de pago por consumo. La Tabla~\ref{tab:budget-total} presenta el desglose final del presupuesto, combinando el coste laboral y el coste real de las suscripciones.
