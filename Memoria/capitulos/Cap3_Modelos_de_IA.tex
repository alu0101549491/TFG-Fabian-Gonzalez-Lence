...
La transición de los proyectos 1--3 al proyecto 4 (\ac{CARTO}) supuso un punto de inflexión, motivado por las limitaciones de escalabilidad del flujo conversacional hasta entonces empleado. En los tres primeros proyectos, el Desarrollador operaba como \textit{chatbot} web: se transfería el código al editor módulo a módulo de forma manual. Este flujo resultaba viable para proyectos de 9 a 15 módulos, pero mostró tres limitaciones críticas al escalar: pérdida de coherencia inter-módulo al generar ficheros en conversaciones independientes; fricción operativa del ciclo manual de copiar, compilar, detectar errores y volver al \textit{chatbot}; e imposibilidad práctica de revisar y testear a la escala de \ac{CARTO}, que llegó a gestionar aproximadamente 240 ficheros en cuatro capas de arquitectura. La solución fue adoptar GitHub Copilot en modo agente como herramienta principal para Codificación, Revisión y \textit{Testing} a partir de \ac{CARTO}, decisión facilitada por un curso de personalización de agentes cursado en el ámbito de ``\textit{Prácticas Externas}'' \cite{URL::TFG}.
...
La Tabla~\ref{tab:comparativa-modelos} sintetiza los modelos empleados: en P1--P3 el equipo se distribuía entre tres \textit{chatbots} independientes; en P4--P5 los roles convergieron en GitHub Copilot con modelos de Claude y GPT como subyacentes. Ningún modelo resultó adecuado para todas las fases, lo que justifica el enfoque multiagente; el rol de Revisor fue el único constante, evidenciando que la integración con el sistema de ficheros resulta crítica en las tareas de revisión.
...
La redacción de esta memoria se apoyó en el modelo Claude Sonnet 4.6 como asistente de escritura LaTeX\footnote{\href{https://es.wikipedia.org/wiki/LaTeX}{LaTeX}}, con un uso de asistencia y transformación, no generativo desde cero: el punto de partida eran siempre notas propias ---borradores en lenguaje llano, listas de ideas y registros en un cuaderno Notion\footnote{\href{https://www.notion.com/es-es}{Notion}} personal--- y el agente proponía reescrituras adaptadas al registro académico del \ac{TFG}. Las tareas delegadas abarcaron la estructuración de capítulos, la condensación de ideas para eliminar redundancias y la aplicación de convenciones de formato LaTeX ---italización de términos en inglés, uso consistente de acrónimos, ajuste de tablas---. En ningún caso operó como fuente primaria de información.