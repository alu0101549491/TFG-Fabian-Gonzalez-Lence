...
I've created a comprehensive UML use case diagram for the Poker Roguelike Game. The diagram captures all the complex mechanics from your requirements:

## **Actors:**

- **Player**: The person playing the poker roguelike game
- **System/Browser**: The application managing game logic and state

## **Use Case Categories (Color-Coded):**

1. **Core Gameplay (Yellow)**: Card selection, playing hands, discarding, dealing, and deck management
2. **Scoring (Orange)**: Score calculation, poker hand detection, base scores, multipliers, and previews
3. **Level Progression (Purple)**: Level completion/failure, boss effects, and level type selection
4. **Special Cards (Blue)**: Planet cards, Tarot cards, and Joker cards with their effects
5. **Economy (Green)**: Earning and spending money
6. **Shop (Red)**: Shop entry, viewing items, purchasing, rerolling, and generation of shop items
7. **Game Flow (Light Red)**: New game, continue, win/lose states, and victory/defeat screens
8. **UI (Gray)**: Main menu, game screen, help, and various display zones
9. **System Operations (Light Purple)**: Persistence, UI updates, validation, and synergy processing

## **Key Features Represented:**

- **Hand Management**: 8-card hand with 5-card selection, up to 3 discards per level
- **Scoring System**: Complex scoring with base chips, multipliers, and synergies
- **Special Cards**: All three types (Planet, Tarot, Joker) with their unique effects
- **Level Types**: Small Blind, Big Blind, and Boss Blind with special boss effects
- **Shop System**: Post-level shopping with reroll functionality
- **Game Progression**: Complete flow from initialization to victory/defeat
- **Synergy Processing**: Card interactions and joker effects applied in proper order

The diagram shows proper **include** relationships for dependencies and **extend** relationships for conditional behaviors (like boss effects and game end conditions).
