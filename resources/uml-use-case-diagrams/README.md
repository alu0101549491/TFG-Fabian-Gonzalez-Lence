...
This directory contains the UML use case diagrams generated for the five projects developed as part of the TFG *"Análisis de Capacidades de la IA en la Generación Semiautomática de Aplicaciones Complejas"* (ULL, 2025–2026).

## Purpose

Use case diagram generation was treated as a design experiment: for each project, one diagram was produced per formalization level of the requirement specification, using the corresponding requirements document as the prompt input to the AI Architect model. The goal was to evaluate how the degree of formalization in the requirements influenced the completeness and accuracy of the generated use case model.
...
|---|---|---|
| `informal.md` | Informal requirements | Use case diagram generated from a free-prose description of the application |
| `semiformal.md` | Semi-formal requirements | Use case diagram generated from a structured template with sections for goals, actors, features and constraints |
| `lnc.md` | Controlled Natural Language (EARS) | Use case diagram generated from EARS-syntax requirements with explicit triggers and conditions |
| `user-stories.md` | User Stories | Use case diagram generated from agile-style user stories (HU-XX format), used for the two most complex projects |
...
These diagrams were produced by the AI Architect model (Claude Sonnet) and later compared and analysed to study how the formalization level of the input requirements affects the resulting use case model. The experiment and its results are discussed in chapters 6 (*Diseño de los Proyectos*) of the written report.
