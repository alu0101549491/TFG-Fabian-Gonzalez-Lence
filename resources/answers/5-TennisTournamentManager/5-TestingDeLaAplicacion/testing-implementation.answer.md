...
3. Introduce stable `data-testid` attributes for the highest-value admin and modal flows to reduce selector fragility.
		...
		Para que luego fuese arreglando poco a poco los tests con respecto a lo que se espera, siendo un proceso en donde se le manda a la IA el resultado en consola, ve que hay tests que fallan por X motivo y empieza a arreglar los fallos que ve con respecto a su rol.