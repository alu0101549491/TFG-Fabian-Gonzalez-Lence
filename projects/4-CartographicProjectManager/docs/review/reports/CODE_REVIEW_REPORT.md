...
| D25-004 | 🟢 LOW ✅ RESOLVED (2026-03-08) | src/presentation/components/layout/AppSidebar.vue | N/A (already removed) | **Unused import indicates lint/type-check drift:** `computed` is imported but never used. | Completed: `computed` import is no longer present in `AppSidebar`. |
