 ...
 * @since March 16, 2026
 * @file src/domain/enumerations/tournament-status.ts
...
/**
 * Type guard to check if a value is a valid TournamentStatus.
 *
 * @param value - The value to check
 * @returns True if the value is a valid TournamentStatus
 */
export function isValidTournamentStatus(value: unknown): value is TournamentStatus {
  return Object.values(TournamentStatus).includes(value as TournamentStatus);
}

/** Array of all tournament statuses for iteration. */
export const ALL_TOURNAMENT_STATUSES = Object.values(TournamentStatus);
